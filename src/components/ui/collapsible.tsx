...
function CollapsibleContent({
	...
	return (
		<BaseCollapsible.Panel
			...
			className={cn(
				"h-[var(--collapsible-panel-height)] overflow-hidden text-sm transition-[height] ease-[cubic-bezier(.25,.46,.45,.94)] duration-300 data-ending-style:h-0 data-starting-style:h-0",
				className
			)}
			{...props}
		/>
